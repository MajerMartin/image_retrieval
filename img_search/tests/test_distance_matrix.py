...
#
#         dm = img_search.distance_matrix.ImageSearchDistanceMatrix(storage_dir)
#
...
#         self.assertEqual(dm.data_path, '/Users/martin.majer/PycharmProjects/PR4/data/dm/data_dm.hdf5')
#
...
#         dm.save()
#
#         dm_copy = img_search.distance_matrix.ImageSearchDistanceMatrix(storage_dir)
#
